...
public class Main3Activity extends AppCompatActivity {
    ...
    public void onButtonClick3(View n){
        String[] words = {"AKMENS","KALNS","SAULE","DIENA","ZEMENES",
                "REIZ","RĪTS","NAKTS","MĒNESS","VAKARS","LAPAS",
                "BALTS","DZIMTENE","MĀJAS","KAROGS","DZĒRVENE","OGAS","IELA",
                "PUĶES","DZĪVE","LIETAS","SVEŠINIEKS",
                "DEBESIS","SIRDS","KAFIJA","BRĪVDIENA","PRĀTS","LĪGAVA","SPOGULIS",
                "VANNA","VILKS","KĀJA","SUNS","ZVAIGZNES","MEITENE",
                "KAIJA","JŪRA","DZIESMA","MĪLESTĪBA","STABS","KOKS","LOGS",
                "CŪKA","ALUMĪNIJS","KUKAINIS","MŪŽS","JĀNIS","JĀŅI",
                "LATVIJA","GAUJA","DAUGAVA","SKRODERIS","APRĪLIS","PILIENI","NĀKOTNE",
                "MIGLA","SĀPES","BUNGAS","DĀRZS","STEPPE","RUDENS","PUIKAS",
                "RAJONS","SEŠPADSMIT","PASAULE","JŪRMALA","LIDMAŠĪNA","ZIBENS",
                "PILSĒTA","RĪGA","BITĪTE","MUCA","MĀTE","CIRCENĪTIS","MAIZE","GALDS","ZIVS"};
